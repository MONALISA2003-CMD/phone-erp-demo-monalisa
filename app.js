...
function applyPermissions(){
  ...
  // Reports is a company/team analysis tool. Team Leaders explicitly
  // should not see it (per instruction), alongside Agent/Shop Staff
  // who are already excluded by being left out of this list.
  const reportsRestricted=['nav-reports'];
  reportsRestricted.forEach(id=>{
    const n=document.getElementById(id);
    if(n)n.style.display=['ceo','admin','regionalmanager','manager','shopmanager'].includes(u.role)?'flex':'none';
  });
